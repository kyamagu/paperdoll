...
int read_problem_sparse(const mxArray *label_vec, const mxArray *instance_mat)
{
	...
	mxArray *instance_mat_col = NULL; // instance sparse matrix in column format
	...
	if(col_format_flag)
		instance_mat_col = mxDuplicateArray(instance_mat);
	else
	{
	...
	if(!instance_mat_col)
		mexErrMsgIdAndTxt("liblinear:error","malloc error");
	...
	mxDestroyArray(instance_mat_col);
