function output = gzipdecompress(input)
%GZIPDECOMPRESS Decompress input bytes using GZIP.
%
%    output = gzipdecompress(input)
%
% The function takes a compressed byte array INPUT and returns inflated
% bytes OUTPUT. The INPUT is a result of GZIPCOMPRESS function. The OUTPUT
