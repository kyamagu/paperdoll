...
GCODIR = fullfile(GCOMATDIR, 'src'); % fileparts(GCOMATDIR);
OUTDIR = [ GCOMATDIR filesep 'private' ];
[status msg msgid] = mkdir(GCOMATDIR, 'private'); % Create private directory
...
SRCCPP = { 
    [GCODIR filesep 'gco_matlab.cpp'], % [GCOMATDIR filesep 'gco_matlab.cpp'],
